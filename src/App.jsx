...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Dynamically load Google GSI client SDK script if missing
    ...
    if (!existingScript) {
      ...
      script.onerror = () => console.error("Failed to load Google Sign-In SDK script.");
      document.head.appendChild(script);
    } else {
      initGoogleGSI();
    }
  ...
  const handleMetaLogin = async () => {
    if (typeof window.FB === 'undefined') {
      triggerToast("Loading Facebook SDK...", "blue");
      try {
        await new Promise((resolve, reject) => {
          ...
          const scriptSrc = "https://connect.facebook.net/en_US/sdk.js";
          let existingScript = document.getElementById('facebook-jssdk');
          if (!existingScript) {
        ...
        triggerToast("Failed to load Facebook SDK. Please try again.", "red");
        return;
      }
    }

    if (!window.FB) {
      triggerToast("Facebook SDK has not loaded yet. Please try again.", "red");
      return;
    }
        ...
        <Suspense fallback={
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
              ...
              <div style={{ fontWeight: '600' }}>Loading FrontDesk AI...</div>
            </div>
          </div>
        }>
          <LandingPage 
